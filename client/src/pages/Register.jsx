        ...
        <div className="bg-white/70 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/50">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-1">
              ...
              <select
                {...register("role")}
                className="w-full px-4 py-2 rounded-lg bg-white/70 backdrop-blur-sm border border-gray-200
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-green-600 text-white rounded-lg font-medium
                       transform transition-all duration-200 hover:bg-green-700 hover:scale-[1.02]
